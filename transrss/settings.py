"""
Django settings for transrss project.
...
INSTALLED_APPS = [
    ...
    'transrss_manager.apps.TransrssManagerConfig'
]
...
WSGI_APPLICATION = 'transrss.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(default=os.getenv('DATABASE_URI', 'sqlite:///db/db.sqlite3'))
}
